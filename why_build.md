...
Different build configurations, Different behavior and constraints, No code modification required
...
Braking, Steering, Powertrain und ADAS

ISO 26262 requires:

Reproducible builds, Traceable configurations, Deterministic behavior

If developers “just change code and compile”:

Builds cannot be reproduced, Safety audits will fail, Certification is impossible
...
OEMs, Tier-1 suppliers, Tier-2 suppliers, etc. 
